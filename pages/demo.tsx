    ...
    <Layout>
      <div className="space-y-12">
        ...
        <section>
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Scan 1 — Initial System Snapshot</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Scan 2 — System After One Sprint</h2>
          <p className="text-gray-700 leading-relaxed mb-6">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-800 mb-4">ArcSight Detects Structural Drift</h2>
          {drift ? (
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 space-y-4 mb-6">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Why It Matters</h2>
          <p className="text-gray-700 leading-relaxed mb-6">
        ...
        <section className="text-center">
          <a
            ...
            className="inline-block py-2 px-6 border border-gray-300 rounded-lg hover:bg-gray-100 text-center text-gray-700"
          >
        ...
        <div className="border-t border-gray-200 pt-8 flex justify-between">
          ...
          <Link href="/arc-drift" className="text-sm text-blue-600 hover:text-blue-800 underline">
            View Raw Results →
          </Link>
        </div>
      </div>
